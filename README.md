...
这个仓库用于保存源码、文档和后续更新记录。打包产物默认放在本地 `release/`，不提交到 Git；正式分发通过 GitHub Releases 附件提供 Windows exe 和 macOS zip。
...
```text
release/Lan-Control-Hub-0.2.0-win-x64-portable.exe
release/Lan-Control-Hub-0.2.0-win-x64-setup.exe
```
